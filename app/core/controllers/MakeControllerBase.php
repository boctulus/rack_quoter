...
class MakeControllerBase extends Controller
{
    ...
    */
    ...
    function task($name, ...$opt) {
        $namespace = 'boctulus\SW\\jobs\\tasks';
    ...
    function interface($name, ...$opt) {
        ...
        if ($core){
            ...
            $namespace = 'boctulus\SW\\interfaces';
    ...
    function helper($name, ...$opt) {
        ...
        if ($core){
            $namespace = 'boctulus\SW\\core\\helpers';
            $dest_path = Constants::CORE_HELPERS_PATH;
        } else {
            $namespace = 'boctulus\SW\\helpers';
    ...
    */
    ...
    function model($name, ...$opt) { 
        ...
        if (!$no_check || $schemaless){
            if (!$schemaless){
                $imports[] = "use boctulus\SW\schemas\\$folder{$this->camel_case}Schema;";
            }
            ...
            $uuid = $this->getUuid();
            if ($uuid){
                $imports[] = 'use boctulus\SW\core\traits\Uuids;';
                $traits[] = 'use Uuids;';      
            }
